<!DOCTYPE html>
<!-- saved from url=(0050)http://gloriatheme.com/demo/html/bonica/index.html -->
...
<?php include 'header.php';?>			
		<!-- HEADER END -->
		<!-- SLIDER START -->
		<section class="slider-area" style="height: 567px;">
			<section id="carousel-example-generic" class="carousel slide carousel-fade" data-interval="8000" data-ride="carousel">
				...
				<a class="left carousel-control left-slider-arrow" href="http://gloriatheme.com/demo/html/bonica/index.html#carousel-example-generic" role="button" data-slide="prev">
					<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
					<span class="sr-only">Previous</span>
				</a>
				<a class="right carousel-control right-slider-arrow" href="http://gloriatheme.com/demo/html/bonica/index.html#carousel-example-generic" role="button" data-slide="next">
								...
								<div class="row clearfix">
									...
									<div class="col-lg-6 col-sm-6 col-xs-12">
										<div class="home-blog-box-item">
											...
											<div class="small-blog-list-cat-name"><span><?php echo $article -> category_name;?></span></div>
											...
											<p><?php 
												echo mb_strlen($article -> content)<10?$article -> content:mb_substr($article -> content,0,10)."...";?>
											</p>
						...
						<div class="sidebar-right">
							...
							<div class="widget-box">
								...
								<div class="about-widget">
									...
									<p>大家好，欢迎大家来到吴双的博客，在这里可以让你进一步了解到我，想要进一步了解我嘛，可以好好浏览一番我的网站喔~</p>
								</div>
							</div>
							<!-- WIDGET ITEM END -->
							<!-- WIDGET ITEM START -->
